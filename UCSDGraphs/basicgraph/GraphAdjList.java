...
public class GraphAdjList extends Graph {
	...
	public List<Integer> getNeighbors(int v) {
		/* Note: Do not return direct reference to edge list
		object in a mutable declared as private! */
		return new ArrayList<Integer>(adjListsMap.get(v)); // return copy of edge list
	}
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 for (int w : adjListsMap.get(v)) { // 1st hop
			 for (int x: adjListsMap.get(w)) { // 2nd hop
				 ans.add(x);
			 }
